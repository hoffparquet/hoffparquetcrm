...
This version adds **invoices** on top of the first phase (clients, pipeline,
quotations): products and installation invoices, kept strictly separate, with
bank details, VAT invoice fields, and the "draft an invoice from a sent quote"
shortcut — all carried over from the original.

Order sheets, the product catalog, margins, and settings editing are not in
this version yet — they're next, once this phase is confirmed working.
...
Order sheets, the product catalog (with retail/B2B pricing), the margins view, and
the settings page for editing your letterhead — tell me when you're ready and I'll
build the next one.
