...
export const DEFAULT_TERMS = [
  ...
  "A deposit is required to confirm the order, with the balance due before delivery to site unless otherwise agreed in writing.",
...
export const DEFAULT_INVOICE_TERMS_PRODUCTS = [
  "Payment is due within 14 days of the invoice date, by bank transfer to the details above unless otherwise agreed.",
  "Goods remain the property of Hoff Parquet until paid for in full.",
